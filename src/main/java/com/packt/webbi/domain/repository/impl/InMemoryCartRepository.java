...
import com.packt.webbi.domain.CartItem;
import com.packt.webbi.domain.Product;
import com.packt.webbi.domain.repository.CartRepository;
import com.packt.webbi.dto.CartDto;
import com.packt.webbi.dto.CartItemDto;
...
@Override
public int countCartItems(String id) {
	 String SQL = "SELECT * FROM cart WHERE ID = :id";  
	    Map<String, Object> params = new HashMap<String, Object>();
	    params.put("id", id);  
	    CartMapper cartMapper = new CartMapper(jdbcTempleate, productService);
	    ...
	    try {
	       Cart a = jdbcTempleate.queryForObject(SQL, params, cartMapper);
	       int count = 0;
	       for(CartItem cartItem : a.getCartItems())
	       {
