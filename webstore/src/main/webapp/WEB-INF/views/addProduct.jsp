...
<section class="container">
	<form:form method="POST" modelAttribute="newProduct"
		...
		ng-app="adminDashBoard" ng-controller="adminDashBoardCtrl">
		...
		<fieldset>
			...
			<div class="form-group">
				<label class="control-label col-lg-2" for="quality"><spring:message
						code="addProduct.form.quality.label" /></label>
				<div class="col-lg-10">
					<form:radiobutton path="quality" value="New" />
					Mới
					<form:radiobutton path="quality" value="Old" />
					Cũ
					<form:radiobutton path="quality" value="Refurbished" />
					Tân trang
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-lg-offset-2 col-lg-10">
					<input type="submit" id="btnAdd" class="btn btn-primary"
						value="Add" ng-click="removeFromCategory('${productID}','${categoryId}','${pagename}')"/>
				</div>
			</div>
		</fieldset>
	</form:form>
